...
type Transformer = (code: string, id: string, path: string, query: Record<string, string>) => Awaitable<any | null>;
...
export { ComponentInfo as C, ImportInfoLegacy as I, Matcher as M, Options as O, ResolvedOptions as R, SideEffectsInfo as S, Transformer as T, ImportInfo as a, ComponentResolveResult as b, ComponentResolverFunction as c, ComponentResolverObject as d, ComponentResolver as e, SupportedTransformer as f, TypeImport as g };
