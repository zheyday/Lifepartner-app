...
const DISABLE_COMMENT = "/* vite-plugin-uni-components disabled */";
const DIRECTIVE_IMPORT_PREFIX = "v";

Boolean(process.env.SSR || process.env.SSG || process.env.VITE_SSR || process.env.VITE_SSG);
...
export { DIRECTIVE_IMPORT_PREFIX as D, DISABLE_COMMENT as a, parseId as b, getNameFromFilePath as c, shouldTransform as d, camelCase as e, getTransformedPath as g, isExclude as i, kebabCase as k, matchGlobs as m, normalizeComponetInfo as n, pascalCase as p, resolveAlias as r, stringifyComponentImport as s };
